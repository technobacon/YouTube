...
| AFK logout timer | Base: 5 min idle logout (out of combat). Official client now offers a customisable timer in 5-min increments up to 25 min (default 5); Jagex aimed for 30 but hit a technical snag | [Poll 84 update](https://oldschool.runescape.wiki/w/Update:Poll_84,_AFK_Timers_%26_More), OSRS Wiki: Idle | 2026-07-03 | Jagex engineered *more* permission to ignore the game — polled, even. |
| Jagex "low intensity" design language | Project Rebalance blog: intention "to provide attractive alternatives for low intensity skillers"; community consultation found players want "low intensity, social training methods"; Forestry designed as social/low-competition woodcutting | [Project Rebalance Part One](https://oldschool.runescape.wiki/w/Update:Project_Rebalance_Part_One_-_Skilling), Forestry wiki | 2026-07-03 | Direct dev vocabulary for the attention axis — quote exactly at script stage. |
| William James attention quote | "My experience is what I agree to attend to" — Principles of Psychology (1890) | memory, high confidence | 2026-07-03 | Verify exact wording before on-screen use. |
